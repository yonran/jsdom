...
function descendants(e, tagName, recursive) {
  ...
  return core.createArrayLike(new core.HTMLCollection(owner, core.mapper(e, function(n) {
...
core.HTMLDocument.prototype = {
  ...
  get applets() {
    return core.createArrayLike(new core.HTMLCollection(this, core.mapper(this, function(el) {
      if (el && el.tagName) {
...
define('HTMLFormElement', {
  ...
  proto: {
    get elements() {
      return core.createArrayLike(new core.HTMLCollection(this._ownerDocument, core.mapper(this, function(e) {
...
define('HTMLSelectElement', {
  ...
  proto: {
    get options() {
      if (!this._options) {
        this._options = core.createArrayLike(new core.HTMLOptionsCollection(this, core.mapper(this, function(n) {
...
define('HTMLTableElement', {
  ...
  proto: {
    ...
    get rows() {
      if (!this._rows) {
        var table = this;
        this._rows = core.createArrayLike(new core.HTMLCollection(table, function() {
...
define('HTMLTableRowElement', {
  ...
  proto: {
    get cells() {
      if (!this._cells) {
        this._cells = core.createArrayLike(new core.HTMLCollection(this, core.mapper(this, function(n) {
