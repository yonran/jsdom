...
core.NodeList.prototype.__proto__ = 
  proxy.create({
    get: function(receiver, name) {console.log('proxyget:'); return receiver.item(name);},
    set: function(receiver, name, value) {console.log('proxyget:'); return receiver[name] = value;},
